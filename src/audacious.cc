...
static const PreferencesWidget prefs_fps[] = {
    ...
    WidgetSpin(
        "Every", WidgetInt(CFGID, "effect_time"), { 50, 500, 5, "frames" }),
    WidgetLabel("<b>How often change colors</b>"),
    WidgetSpin(
        "Every", WidgetInt(CFGID, "palette_time"), { 50, 500, 5, "frames" }),
...
static const PreferencesWidget prefs_widgets[] = { WidgetBox(
    { { prefs_fps } }) };
...
{
public:
    static constexpr PluginInfo info = { "Infinity", PACKAGE, about_text,
                                         &preferences };
...
static const char* const defaults[] = {
    "width",   "512",          "height", "288",          "effect_time",
    "100",     "palette_time", "100",    "scale_factor", "1",
    "max_fps", "30",           nullptr
};
